...
set USE_JAVAFX=true
set JAVAFX_HOME=C:\javafx-sdk-17.0.2
...
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\Mian.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% Mian
IF /I "%ERRORLEVEL%" NEQ "0" (
